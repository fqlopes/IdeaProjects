...
//            }
    ...
    public static void singlemain(String[] args) {
        ...
        if (isDone) {
            System.out.println("Blue is finished, yellow is starting");
        ...
        if (isDone) {
            System.out.println("Yellow is finished, red is starting");
    ...
    private static Integer sum(int start, int end, int delta, String colorString) {
