...
public class Main {
    public static void main(String[] args) {
        ...
        IntStream.iterate((int) 'A', i -> i <= (int) 'z', i -> i + 1)
                ...
                .distinct()
//                .dropWhile(i -> Character.toUpperCase(i) <= 'E') // elements don't get added until the condition is met
//                .takeWhile(i -> i < 'a')
//                .skip(5) // skips n elements
//                .filter(i -> Character.toUpperCase(i) > 'E') // char elements that are less than 'E' are ignored
