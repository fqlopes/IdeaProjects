...
public class Main {
    public static void main(String[] args) {
        ...
        var whatIsThis = ZoneId.getAvailableZoneIds();
        System.out.println("Number of TZ's = " + ZoneId.getAvailableZoneIds().size());
...
//                ZoneId.of("America/Sao_Paulo"),
        ...
        Instant dobInstant = Instant.parse("2020-01-01T08:01:00Z"); // Z -> means its UTC
