...
public class Student {
    ...
    public static Student getRandomStudent(Course... courses) {
        ...
        Student student = new Student(getRandomVal("AU", "CA", "CN", "GB", "IN", "UA", "US"), random.nextInt(2015, maxYear), random.nextInt(18, 90), getRandomVal("M", "F", "U"), random.nextBoolean(), randomCourses);
