...
//                updateRecord(statement, tableName, columnName, columnValue, columnName, columnValue.toUpperCase());
    ...
    private static boolean executeSelect(Statement statement,
    ...
    private static boolean insertRecord(Statement statement,
                                        String table,
                                        String[] columnNames,
                                        String[] columnValues)
            throws SQLException{
    ...
    private static boolean deleteRecord(Statement statement,
                                        String table,
                                        String columnName,
                                        String columnValue)
            throws SQLException {
    ...
    private static boolean updateRecord(Statement statement,
                                        String table,
...
//            System.out.printf("Deleted %d rows from music.albums%n", deletedAlbums);
            String deleteArtists = "DELETE FROM music.artists WHERE artist_name = '%s'".formatted(artistName);
//            int deletedArtists = statement.executeUpdate(deleteArtists);
//            System.out.printf("Deleted %d rows from music.artists%n", deletedArtists);
            ...
            statement.addBatch(deleteArtists);
