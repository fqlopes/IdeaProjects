...
public class Main {
    public static void main(String[] args) {
        ...
        doOperation("Read and Print: ", buffer, printBuffer);

        doOperation("Flip(From Read to Write): ", buffer,ByteBuffer::flip);
//        doOperation("1. Move position to the end of text", buffer, (b) -> b.position(b.limit()));
...
//        doOperation("Flip (From Write to Read): ",buffer, ByteBuffer::flip);
        doOperation("Read and Print: ", buffer.slice(0, buffer.position()), printBuffer);
