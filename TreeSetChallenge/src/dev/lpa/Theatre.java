...
public class Theatre {
    ...
    public String reserveSeat (char row, int seat){
        ...
        Seat request = new Seat (row, seat);
        Seat requested = seats.floor(request);

        if (requested == null || !requested.seatNum.equals(request.seatNum)){
            System.out.println("No such seat: " + requested);
